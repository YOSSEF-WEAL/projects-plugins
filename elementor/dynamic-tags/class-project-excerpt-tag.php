...
if (
    !class_exists('PP_Project_Excerpt_Tag') &&
    class_exists('PP_Project_Base_Tag') &&
    class_exists('\Elementor\Modules\DynamicTags\Module')
) {
    class PP_Project_Excerpt_Tag extends PP_Project_Base_Tag {
        public function get_name() {
            return 'pp-project-excerpt';
        }

        public function get_title() {
            return __('Project Excerpt', 'projects-plugin');
        }
